...
@section('vendor-style')
    @vite(['resources/assets/vendor/scss/pages/add-product.scss', 'resources/assets/vendor/libs/quill/typography.scss', 'resources/assets/vendor/libs/quill/katex.scss', 'resources/assets/vendor/libs/quill/editor.scss', 'resources/assets/vendor/libs/select2/select2.scss', 'resources/assets/vendor/libs/dropzone/dropzone.scss', 'resources/assets/vendor/libs/flatpickr/flatpickr.scss', 'resources/assets/vendor/libs/tagify/tagify.scss'])
@endsection

@section('content')
    <div class="container-fluid add-product-wrapper">
        <div class="row">
            @if (session('success'))
                    ...
                    <div class="tab-content" id="productTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="basic" role="tabpanel"
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input value="{{ old('product_slug') }}" type="text"
                                                    class="form-control @error('product_slug') is-invalid @enderror"
                                                    id="product_slug" name="product_slug" required>
                                        ...
                                        <div class="col-md-6">
                                            <label for="vendor_id" class="form-label">Vendor <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-6">
                                            <label for="product_type" class="form-label">Product Type <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select select2 @error('product_type') is-invalid @enderror"
                                                id="product_type" name="product_type" required>
                                                <option value="">Select Type</option>
                                                <option value="physical"
                                                    {{ old('product_type') == 'physical' ? 'selected' : '' }}>Physical
                                                    Product</option>
                                                <option value="digital"
                                                    {{ old('product_type') == 'digital' ? 'selected' : '' }}>Digital
                                                    Product</option>
                                                <option value="service"
                                                    {{ old('product_type') == 'service' ? 'selected' : '' }}>Service
                                                </option>
                                                <option value="subscription"
                                                    {{ old('product_type') == 'subscription' ? 'selected' : '' }}>
                                                    Subscription</option>
                                                <option value="bundle"
                                                    {{ old('product_type') == 'bundle' ? 'selected' : '' }}>Bundle</option>
                                            </select>
                                            @error('product_type')
                                        ...
                                        <div class="col-md-6">
                                            <label for="primary_category_name" class="form-label">Primary Category <span
                                                    class="text-danger">*</span></label>
                                            <select
                                                class="form-select select2 @error('primary_category_name') is-invalid @enderror"
                                                id="primary_category_name" name="primary_category_name" required>
                                                <option value="">Select Category</option>
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('primary_category_name') == $category->id ? 'selected' : '' }}>
                                                        {{ $category->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select select2" id="collections" name="collections[]"
                                                multiple>
                                        ...
                                        <div class="col-md-6">
                                            <label for="brand" class="form-label">Brand Name <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('brand_name') }}" type="text"
                                                class="form-control @error('brand_name') is-invalid @enderror"
                                                id="brand" name="brand_name" required>
                                            @error('brand_name')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="tags" name="tags[]"
                                                value="{{ old('tags') ? json_encode(old('tags')) : '' }}">
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="full_description" class="form-label">Full Description <span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control rich-editor @error('full_description') is-invalid @enderror" id="full_description"
                                            name="full_description" rows="6" required>{{ old('full_description') }}</textarea>
                                            ...
                                            @if (old('features'))
                                                @foreach (old('features') as $feature)
                                                    <div class="input-group mb-2">
                                                        <input value="{{ $feature }}" type="text"
                                                            class="form-control" name="features[]"
                                                            placeholder="Product feature">
                                                        <button class="btn btn-outline-secondary remove-feature"
                                                            type="button">
                                        ...
                                        <div id="benefits-container">
                                            @if (old('benefits'))
                                                @foreach (old('benefits') as $benefit)
                                                    <div class="input-group mb-2">
                                                        <input value="{{ $benefit }}" type="text"
                                                            class="form-control" name="benefits[]"
                                                            placeholder="Product benefit">
                                                        <button class="btn btn-outline-secondary remove-benefit"
                                                            type="button">
                                                            <i class="ti ti-trash"></i>
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input value="{{ old('base_price') }}" type="number"
                                        ...
                                        <div class="col-md-4">
                                            <label for="current_price" class="form-label">Current Price <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input value="{{ old('current_price') }}" type="number"
                                                    class="form-control @error('current_price') is-invalid @enderror"
                                                    id="current_price" name="current_price" step="0.01"
                                                    min="0" required>
                                            </div>
                                            @error('current_price')
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input value="{{ old('cost_price') }}" type="number"
                                        ...
                                        <div class="col-md-4">
                                            <label for="tax_class" class="form-label">Tax Class <span
                                                    class="text-danger">*</span></label>
                                            <select class="form-select @error('tax_class') is-invalid @enderror"
                                                id="tax_class" name="tax_class" required>
                                                <option value="standard"
                                                    {{ old('tax_class') == 'standard' ? 'selected' : '' }}>Standard
                                                </option>
                                                <option value="reduced"
                                                    {{ old('tax_class') == 'reduced' ? 'selected' : '' }}>Reduced Rate
                                                </option>
                                                <option value="zero" {{ old('tax_class') == 'zero' ? 'selected' : '' }}>
                                                    Zero Rate</option>
                                            </select>
                                            @error('tax_class')
                                        ...
                                        <div class="col-md-4">
                                            <label for="tax_rate" class="form-label">Tax Rate (%) <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('tax_rate') }}" type="number"
                                                class="form-control @error('tax_rate') is-invalid @enderror"
                                                id="tax_rate" name="tax_rate" step="0.01" min="0"
                                                max="100" required>
                                            @error('tax_rate')
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="price_includes_tax"
                                                    name="price_includes_tax" value="1"
                                                    {{ old('price_includes_tax') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="price_includes_tax">Price includes
                                                    tax</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-select" id="discount_type" name="discount_type">
                                                ...
                                                <option value="fixed"
                                                    {{ old('discount_type') == 'fixed' ? 'selected' : '' }}>Fixed Amount
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <label for="discount_value" class="form-label">Discount Value</label>
                                            <input value="{{ old('discount_value') }}" type="number"
                                                class="form-control" id="discount_value" name="discount_value"
                                                step="0.01" min="0">
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input
                                                    value="{{ old('discount_start_date') && old('discount_end_date') ? old('discount_start_date') . ' to ' . old('discount_end_date') : '' }}"
                                                    type="text" class="form-control date-range-picker"
                                                    id="discount_dates" placeholder="Select date range">
                                                <input type="hidden" name="discount_start_date" id="discount_start_date"
                                                    value="{{ old('discount_start_date') }}">
                                                <input type="hidden" name="discount_end_date" id="discount_end_date"
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                            <input value="{{ old('barcode') }}" type="text" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="inventory_tracking"
                                                    name="inventory_tracking" value="1"
                                                    {{ old('inventory_tracking', '1') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="inventory_tracking">Track inventory
                                        ...
                                        <div class="col-md-4 inventory-field">
                                            ...
                                            <input value="{{ old('stock_quantity') }}" type="number"
                                                ...
                                                id="stock_quantity" name="stock_quantity" min="0" required>
                                        ...
                                        <div class="col-md-4 inventory-field">
                                            ...
                                            <select class="form-select @error('stock_status') is-invalid @enderror"
                                                ...
                                                <option value="on_backorder"
                                                    {{ old('stock_status') == 'on_backorder' ? 'selected' : '' }}>On
                                                    Backorder</option>
                                            </select>
                                            @error('stock_status')
                                        ...
                                        <div class="col-md-4 inventory-field">
                                            <label for="low_stock_threshold" class="form-label">Low Stock Threshold <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('low_stock_threshold') }}" type="number"
                                                class="form-control @error('low_stock_threshold') is-invalid @enderror" i
                                                }}" type="number"
                                        ...
                                        <div class="col-md-4 inventory-field">
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="allow_backorders"
                                                    ...
                                                    {{ old('allow_backorders') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="allow_backorders">Allow
                                                    backorders</label>
                                            </div>
                                        </div>
                                        <div class="col-md-4 inventory-field">
                                            <label for="min_order_quantity" class="form-label">Min Order Quantity <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('min_order_quantity', 1) }}" type="number"
                                                class="form-control" id="min_order_quantity" name="min_order_quantity"
                                                min="1" required>
                                        </div>
                                        <div class="col-md-4 inventory-field">
                                            <label for="max_order_quantity" class="form-label">Max Order Quantity <span
                                                    class="text-danger">*</span></label>
                                            <input value="{{ old('max_order_quantity', 100) }}" type="number"
                                                class="form-control" id="max_order_quantity" name="max_order_quantity"
                                                min="1" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input value="{{ old('alt_text') }}" type="text" class="form-control"
                                ...
                                <div class="card-body">
                                        ...
                                        <div id="video-urls-container">
                                            @if (old('video_urls'))
                                                @foreach (old('video_urls') as $video_url)
                                                    <div class="input-group mb-2">
                                                        <input value="{{ $video_url }}" type="url"
                                                            class="form-control" name="video_urls[]"
                                                            placeholder="https://www.youtube.com/watch?v=...">
                                                        <button class="btn btn-outline-secondary remove-video"
                                                            type="button">
                                                            <i class="ti ti-trash"></i>
                                                        </button>
                                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="document-upload-container">
                                            ...
                                            <input type="file" class="form-control visually-hidden" id="document_urls"
                                                name="document_urls[]" accept=".pdf,.doc,.docx,.xls,.xlsx" multiple>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="variants" role="tabpanel" aria-labelledby="variants-tab">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="form-check form-switch mb-3">
                                        ...
                                        <label class="form-check-label" for="has_variants">This product has multiple
                                            variants</label>
                                    </div>
                                    ...
                                    <div id="variants-container" style="display: none;">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select select2" id="variant_attributes"
                                                name="variant_attributes[]" multiple>
                                                <option value="color"
                                                    {{ in_array('color', old('variant_attributes', [])) ? 'selected' : '' }}>
                                                    Color</option>
                                                <option value="size"
                                                    {{ in_array('size', old('variant_attributes', [])) ? 'selected' : '' }}>
                                                    Size</option>
                                                <option value="material"
                                                    {{ in_array('material', old('variant_attributes', [])) ? 'selected' : '' }}>
                                                    Material</option>
                                                <option value="style"
                                                    {{ in_array('style', old('variant_attributes', [])) ? 'selected' : '' }}>
                                                    Style</option>
                                                <option value="weight"
                                                    {{ in_array('weight', old('variant_attributes', [])) ? 'selected' : '' }}>
                                                    Weight</option>
                                            </select>
                                            <small class="text-muted">Select attributes that define your product
                                                variants</small>
                                        </div>
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <p class="text-muted">Add attributes that don't create variants (e.g., material,
                                            care instructions)</p>
                                                ...
                                                @foreach (old('attributes') as $index => $attribute)
                                                    <div class="row mb-2 attribute-row">
                                                        <div class="col-md-5 mt-1">
                                                            <input value="{{ old("attributes.$index.name") }}"
                                                                type="text" class="form-control"
                                                                name="attributes[{{ $index }}][name]"
                                                                placeholder="Attribute name (e.g., Material)">
                                                        </div>
                                                        <div class="col-md-5 mt-1">
                                                            <input value="{{ old("attributes.$index.value") }}"
                                                                type="text" class="form-control"
                                        ...
                                        <div id="specifications-container">
                                                ...
                                                @foreach (old('specifications') as $index => $spec)
                                                    <div class="row mb-2 specification-row">
                                                        <div class="col-md-3 mt-1">
                                                            <input value="{{ old("specifications.$index.group") }}"
                                                                type="text" class="form-control"
                                                                name="specifications[{{ $index }}][group]"
                                                                placeholder="Group (e.g., Dimensions)">
                                                        </div>
                                                        <div class="col-md-3 mt-1">
                                                            <input value="{{ old("specifications.$index.name") }}"
                                                                type="text" class="form-control"
                                                                name="specifications[{{ $index }}][name]"
                                                                placeholder="Name (e.g., Height)">
                                                        </div>
                                                        <div class="col-md-3 mt-1">
                                                            <input value="{{ old("specifications.$index.value") }}"
                                                                type="text" class="form-control"
                                                                name="specifications[{{ $index }}][value]"
                                                                placeholder="Value (e.g., 10)">
                                                        </div>
                                                        <div class="col-md-2 mt-1">
                                                            <input value="{{ old("specifications.$index.unit") }}"
                                                                type="text" class="form-control"
                                                        ...
                                                        <div class="col-md-1 mt-1">
                                                            <button type="button"
                                                                class="btn btn-outline-danger remove-specification">
                                                                <i class="ti ti-trash"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                            ...
                                            @else
                                                <div class="row mb-2 specification-row">
                                                    ...
                                                    <div class="col-md-2 mt-1">
                                                        <input type="text" class="form-control"
                                                            name="specifications[0][unit]" placeholder="Unit">
                                                    </div>
                                                    <div class="col-md-1 mt-1">
                                                        <button type="button"
                                                            class="btn btn-outline-danger remove-specification">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-select" id="weight_unit" name="weight_unit"
                                                    ...
                                                    <option value="kg"
                                                        {{ old('weight_unit', 'kg') == 'kg' ? 'selected' : '' }}>kg
                                                    </option>
                                                    <option value="g"
                                                        {{ old('weight_unit') == 'g' ? 'selected' : '' }}>g</option>
                                                    <option value="lb"
                                                        {{ old('weight_unit') == 'lb' ? 'selected' : '' }}>lb</option>
                                                    <option value="oz"
                                                        {{ old('weight_unit') == 'oz' ? 'selected' : '' }}>oz</option>
                                                </select>
                                            </div>
                                            @error('weight')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <input value="{{ old('dimensions.length', '') }}" type="number"
                                                    class="form-control" id="length" name="dimensions[length]"
                                                    step="0.01" min="0" placeholder="L">
                                                <input value="{{ old('dimensions.width', '') }}" type="number"
                                                    class="form-control" id="width" name="dimensions[width]"
                                                    step="0.01" min="0" placeholder="W">
                                                <input value="{{ old('dimensions.height', '') }}" type="number"
                                                    class="form-control" id="height" name="dimensions[height]"
                                                    step="0.01" min="0" placeholder="H">
                                                <select class="form-select" id="dimension_unit" name="dimensions[unit]"
                                                    style="max-width: 100px;">
                                                    <option value="cm"
                                                        {{ old('dimensions.unit', 'cm') == 'cm' ? 'selected' : '' }}>cm
                                                    </option>
                                                    <option value="mm"
                                                        {{ old('dimensions.unit') == 'mm' ? 'selected' : '' }}>mm</option>
                                                    <option value="in"
                                                        {{ old('dimensions.unit') == 'in' ? 'selected' : '' }}>in</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select class="form-select" id="shipping_class" name="shipping_class">
                                                <option value="standard"
                                                    {{ old('shipping_class', 'standard') == 'standard' ? 'selected' : '' }}>
                                                    Standard</option>
                                                <option value="bulky"
                                                    {{ old('shipping_class') == 'bulky' ? 'selected' : '' }}>Bulky
                                                </option>
                                                <option value="heavy"
                                                    {{ old('shipping_class') == 'heavy' ? 'selected' : '' }}>Heavy
                                                </option>
                                                <option value="fragile"
                                                    {{ old('shipping_class') == 'fragile' ? 'selected' : '' }}>Fragile
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="additional_shipping_fee" class="form-label">Additional Shipping
                                                Fee</label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input value="{{ old('additional_shipping_fee', '0') }}" type="number"
                                                    class="form-control" id="additional_shipping_fee"
                                                    name="additional_shipping_fee" step="0.01" min="0">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="free_shipping">This product qualifies
                        ...
                        <div class="tab-pane fade" id="advanced" role="tabpanel" aria-labelledby="advanced-tab">
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <input value="{{ old('meta_title') }}" type="text" class="form-control"
                            ...
                            <!-- In the Advanced Tab, add Custom Fields section after the SEO Information section -->
                            <div class="card shadow-sm mb-4">
                                <div class="card-header">
                                    ...
                                    <div id="custom-fields-container">
                                        @if (old('custom_fields'))
                                            @foreach (old('custom_fields') as $index => $field)
                                                <div class="row mb-2 custom-field-row">
                                                    <div class="col-md-5 mt-1">
                                                        <input value="{{ old("custom_fields.$index.name") }}"
                                                            type="text" class="form-control"
                                                            name="custom_fields[{{ $index }}][name]"
                                                            placeholder="Field name">
                                                    </div>
                                                    <div class="col-md-5 mt-1">
                                                        <input value="{{ old("custom_fields.$index.value") }}"
                                                            type="text" class="form-control"
                                                    ...
                                                    <div class="col-md-1 mt-1">
                                                        <button type="button"
                                                            class="btn btn-outline-danger remove-custom-field">
                                                            <i class="ti ti-trash"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        @else
                                            <div class="row mb-2 custom-field-row">
                                                <div class="col-md-5 mt-1">
                                                    <input type="text" class="form-control"
                                                        name="custom_fields[0][name]" placeholder="Field name">
                                                </div>
                                                <div class="col-md-5 mt-1">
                                                    <input type="text" class="form-control"
                                                        name="custom_fields[0][value]" placeholder="Field value">
                                                </div>
                                                <div class="col-md-1 mt-1">
                                                    <button type="button"
                                                        class="btn btn-outline-danger remove-custom-field">
                            ...
                            <!-- In the Advanced Tab, update the Visibility Settings section -->
                            <div class="card shadow-sm mb-4">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <select class="form-select select2" id="visibility_in" name="visibility_in[]"
                                                multiple>
                                                <option value="search"
                                                    {{ in_array('search', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Search Results</option>
                                                <option value="catalog"
                                                    {{ in_array('catalog', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Catalog</option>
                                                <option value="related"
                                                    {{ in_array('related', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Related Products</option>
                                                <option value="upsell"
                                                    {{ in_array('upsell', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Upsell</option>
                                                <option value="cross_sell"
                                                    {{ in_array('cross_sell', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Cross-sell</option>
                                                <option value="homepage"
                                                    {{ in_array('homepage', old('visibility_in', [])) ? 'selected' : '' }}>
                                                    Homepage</option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <!-- In the Advanced Tab, add Badges and Labels section -->
                            <div class="card shadow-sm mb-4">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="badges" name="badges"
                                                value="{{ old('badges') }}">
                                            <small class="text-muted">Add badges to highlight product (e.g., New, Hot,
                                                Sale)</small>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="labels" name="labels"
                                                value="{{ old('labels') }}">
                                            <small class="text-muted">Add labels to describe product features (e.g.,
                                                Organic, Vegan)</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- In the Advanced Tab, update the Related Products section -->
                            <div class="card shadow-sm mb-4">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="related_products"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="upsell_products"
                                            name="upsell_products[]" multiple>
                                            @foreach ($products as $product)
                                                <option value="">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select select2" id="cross_sell_products"
                                            name="cross_sell_products[]" multiple>
                                            @foreach ($products as $product)
                                                <option value="">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-12">
                                            <div class="form-check form-switch">
                                                ...
                                                <label class="form-check-label" for="is_visible">Visible in
                                                    catalog</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="available_from" class="form-label">Available From</label>
                                            <input value="{{ old('available_from') }}" type="date"
                                                class="form-control" id="available_from" name="available_from">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="available_to" class="form-label">Available To</label>
                                            <input value="{{ old('available_to') }}" type="date"
                                                class="form-control" id="available_to" name="available_to">
                                        </div>
                                        <div class="col-md-12">
                                            <label for="available_in_locations" class="form-label">Available
                                                Locations</label>
                                            <select class="form-select select2" id="available_in_locations"
                                                name="available_in_locations[]" multiple>
                                                @foreach ($countries ?? [] as $country)
                                                    <option value="{{ $country->name }}"
                                                        {{ in_array($country->name, old('available_in_locations', [])) ? 'selected' : '' }}>
                                                        {{ $country->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                            ...
                            <div class="card shadow-sm mb-4">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <label for="warranty_information" class="form-label">Warranty
                                            Information</label>
                                        <textarea class="form-control" id="warranty_information" name="warranty_information" rows="3">{{ old('warranty_information') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="return_policy" class="form-label">Return Policy</label>
                                        <textarea class="form-control" id="return_policy" name="return_policy" rows="3">{{ old('return_policy') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="safety_warnings" class="form-label">Safety Warnings</label>
                                        <textarea class="form-control" id="safety_warnings" name="safety_warnings" rows="3">{{ old('safety_warnings') }}</textarea>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="country_of_origin" name="country_of_origin">
                                            ...
                                            @foreach ($countries ?? [] as $country)
                                                <option value="{{ $country->name }}"
                                                    {{ old('country_of_origin') == $country->name ? 'selected' : '' }}>
                                                    {{ $country->name }}
                                                </option>
                                            @endforeach
                                        </select>
                        ...
                        <!-- Update the Digital Product Tab -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch mb-3">
                                                <input class="form-check-input" type="checkbox" id="is_digital"
                                                    name="is_digital" value="1"
                                                    {{ old('is_digital') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_digital">This is a digital
                                                    product</label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                <input type="file" class="form-control" id="download_file"
                                                    name="download_file">
                                                <span class="input-group-text" id="download_file_size">Size: 0 KB</span>
                                                <span class="input-group-text" id="download_file_type">Type: -</span>
                                            </div>
                                            <small class="text-muted">Upload the file customers will download after
                                                purchase</small>
                                            <input type="hidden" name="download_file_size"
                                                id="download_file_size_input" value="{{ old('download_file_size') }}">
                                            <input type="hidden" name="download_file_type"
                                                id="download_file_type_input" value="{{ old('download_file_type') }}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="download_limit" class="form-label">Download Limit</label>
                                            <input value="{{ old('download_limit') }}" type="number"
                                                class="form-control" id="download_limit" name="download_limit"
                                                min="0"
                                                placeholder="Number of downloads allowed (0 for unlimited)">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="download_expiry" class="form-label">Download Expiry
                                                (days)</label>
                                            <input value="{{ old('download_expiry') }}" type="number"
                                                class="form-control" id="download_expiry" name="download_expiry"
                                                min="0" placeholder="Days until download expires (0 for never)">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-check form-switch mb-3">
                                                <input class="form-check-input" type="checkbox" id="is_subscription"
                                                    ...
                                                    {{ old('is_subscription') == '1' ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_subscription">This is a
                                                    subscription product</label>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="subscription_period" class="form-label">Billing Period</label>
                                            <select class="form-select" id="subscription_period"
                                                name="subscription_period">
                                                <option value="">Select Period</option>
                                                <option value="day"
                                                    {{ old('subscription_period') == 'day' ? 'selected' : '' }}>Daily
                                                </option>
                                                <option value="week"
                                                    {{ old('subscription_period') == 'week' ? 'selected' : '' }}>Weekly
                                                </option>
                                                <option value="month"
                                                    {{ old('subscription_period') == 'month' ? 'selected' : '' }}>Monthly
                                                </option>
                                                <option value="year"
                                                    {{ old('subscription_period') == 'year' ? 'selected' : '' }}>Yearly
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="subscription_period_interval" class="form-label">Billing
                                                Interval</label>
                                            <input value="{{ old('subscription_period_interval', 1) }}" type="number"
                                                class="form-control" id="subscription_period_interval"
                                                name="subscription_period_interval" min="1"
                                                placeholder="Interval between billings">
                                            <small class="text-muted">E.g., 1 for monthly, 3 for quarterly (if period is
                                                month)</small>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="subscription_length" class="form-label">Subscription
                                                Length</label>
                                            <input value="{{ old('subscription_length') }}" type="number"
                                                class="form-control" id="subscription_length"
                                                name="subscription_length" min="0"
                                                placeholder="Number of renewals (0 for unlimited)">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="sign_up_fee" class="form-label">Sign-up Fee</label>
                                            <div class="input-group">
                                                <span class="input-group-text">$</span>
                                                <input value="{{ old('sign_up_fee') }}" type="number"
                                                    class="form-control" id="sign_up_fee" name="sign_up_fee"
                                                    step="0.01" min="0"
                                                    placeholder="One-time fee at sign-up">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="trial_period" class="form-label">Trial Period (days)</label>
                                            <input value="{{ old('trial_period') }}" type="number"
                                                class="form-control" id="trial_period" name="trial_period"
                                                min="0" placeholder="Free trial days (0 for no trial)">
                                        </div>
                                    </div>
                                </div>
                            </div>
